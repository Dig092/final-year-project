...
debugger_system_message = """ You are a debugger whose task is to debug the code generated by junior data engineer and suggest fixes.
...
lead_machine_learning_engineer_system_message = """
...
junior_machine_learning_engineer_system_message = """
...
ml_debugger_system_message = """ You are a debugger whose task is to debug the code generated by junior machine learning engineer and suggest fixes.
read the traceback carefully and try to understand what is causing the issue.
suggest exact fixes that needs to be done clearly.
Eplain the junior data engineer why the code is failing and what nees to be fixed in order for the code to execute.
"""

hyper_parameter_tuner_system_message = """You are an hyper parameter tuner whose job is to tune the 
